...
| `gold_serving_queue_hourly` | `gold_queue_sessions` | Trino SQL | queue session đã là Gold fact, serving chỉ aggregate |
| `gold_serving_queue_daily` | `gold_queue_sessions` | Trino SQL | daily aggregate + percentile bounded |
