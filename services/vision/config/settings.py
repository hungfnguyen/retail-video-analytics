...
def load_cameras_config(path: str | None = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "live_frame_output_dir": os.getenv(
            "LIVE_FRAME_OUTPUT_DIR",
            global_settings.get("live_frame_output_dir", "data/live_frames"),
        ),
        "live_frame_jpeg_quality": _get_int("live_frame_jpeg_quality", global_settings, 80),
        "live_frame_fps": _get_float("live_frame_fps", global_settings, 8.0),
...
def _fallback_single_camera() -> Dict[str, Any]:
    ...
    return {
        ...
        "live_frame_output_dir": os.getenv("LIVE_FRAME_OUTPUT_DIR", "data/live_frames"),
        "live_frame_jpeg_quality": _get_int("live_frame_jpeg_quality", {}, 80),
        "live_frame_fps": _get_float("live_frame_fps", {}, 8.0),
